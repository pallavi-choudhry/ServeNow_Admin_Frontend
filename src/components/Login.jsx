...
//             <p className="text-sm text-gray-500 mb-6">Login to get amazing discounts and offers only for you.</p>
 ...
 const handleChange = (e) => {
  ...
  return (
    <div className="flex items-center justify-center h-screen">
      <div className="flex w-[800px] h-[480px] shadow-2xl rounded-2xl overflow-hidden bg-white">
        <div className="w-1/2 bg-gradient-to-br from-red-400 to-red-500 text-white p-8 flex flex-col justify-between">
          <div>
            <h2 className="text-2xl font-bold mb-4"></h2>
            <p className="text-sm leading-relaxed"></p>
          </div>
          <p className="text-xs text-white tracking-wide"></p>
        </div>
        ...
        <div className="w-1/2 p-8 flex flex-col justify-center">
          <form onSubmit={handleSubmit}>
            ...
            <label className="text-sm font-medium text-gray-700">Email</label>
            <input type="email" name="email" value={formData.email} onChange={handleChange} required className="w-full p-3 mt-1 mb-4 border border-gray-300 rounded-lg" />

            <label className="text-sm font-medium text-gray-700">Password</label>
            <div className="relative">
              <input type={showPassword ? 'text' : 'password'} name="password" value={formData.password} onChange={handleChange} required className="w-full p-3 mt-1 mb-4 border border-gray-300 rounded-lg pr-10" />
              <span onClick={() => setShowPassword(!showPassword)} className="absolute right-3 top-5 text-gray-500 cursor-pointer">
                {/* <FontAwesomeIcon icon={showPassword ? faEyeSlash : faEye} /> */}
              </span>
            </div>

            <button type="submit" className="w-full bg-red-500 text-white py-3 rounded-lg">LOGIN</button>
