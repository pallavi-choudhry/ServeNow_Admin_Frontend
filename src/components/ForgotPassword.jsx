...
function ForgotPassword() {
  ...
  const handleEmailSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('http://localhost:5000/api/admin/forgotpassword', { email });
      if (res.status === 200) {
        setStep(2);
  ...
  const handleOtpSubmit = async (e) => {
    ...
    try {
      const res = await axios.post('http://localhost:5000/api/admin/verifyOtp', { email, otp });
      if (res.status === 200) {
        setStep(3);
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const res = await axios.post('http://localhost:5000/api/admin/resetpassword', {
        email,
